...
export const DeveloperJourney: React.FC = () => {
  return (
    <section id="journey" className="relative py-10 sm:py-12 px-6 sm:px-8 lg:px-12 max-w-6xl mx-auto z-10">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <BentoCard className="h-full border-white/8 hover:border-white/20 p-7 sm:p-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-brand-cyan">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-5 text-sm text-slate-300 font-mono">
              <span className="text-white font-semibold">{educationData[0].institution}</span>
        ...
        >
          <BentoCard className="h-full border-white/8 hover:border-white/20 p-7 sm:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
              ...
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 space-y-2">
                ...
                <p className="text-xs text-brand-cyan font-mono font-medium">
