...
export const CertificationsSection: React.FC = () => {
  return (
    <section id="certifications" className="relative py-10 sm:py-12 px-4 sm:px-8 lg:px-12 max-w-6xl mx-auto z-10 w-full">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {certificationsData.map((cert) => (
          <div
            ...
            data-cinematic-card
          >
            <BentoCard className="h-full flex flex-col justify-between border-white/8 hover:border-white/20 p-5 sm:p-7 group overflow-hidden">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-3">
                  <span className="text-xs font-mono text-brand-cyan tracking-wide font-medium break-words">
                    {cert.issuer}
                  </span>
                  {cert.tag && (
                ...
                <h3 className="text-base sm:text-lg font-display font-bold text-white mb-3 tracking-tight break-words">
                  {cert.title}
                </h3>
              </div>

              <div className="pt-6 border-t border-white/8 flex flex-wrap items-center justify-between gap-2.5">
